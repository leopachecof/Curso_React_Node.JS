...
export function Dicionario() {
    ...
    useEffect(() => {
        ...
        for(let elemento of palavras) {
            if(elemento.palavra.indexOf(busca) > -1) { // Quando a palavra é diferente aparece -1, mas se for igual, vem algum valor. Ou seja, vai buscar todas as palavras que tem uma letra igual ao que está procurando
